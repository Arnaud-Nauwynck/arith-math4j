 ...
 */
public class PrimesSieve extends IPrimes {
	 ...
	 */
	public long generatePrime(long start) {
		...
		throw new RuntimeException("No Prime found for value " + start);
	}
	 ...
	 * @throws Exception if no prime < start was found
	 */
	public long generatePreviousPrime(long start) {
		// >>!! could be optimized
